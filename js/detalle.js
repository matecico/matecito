document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!producto) {
        if (contenedor) contenedor.innerHTML = "<h2 style='color: white; text-align: center; margin-top: 40px;'>Producto no encontrado</h2>";
        return;
    }

    const precioTarjetaBase = Math.round(producto.precio * 1.08);

    // 1. Inyectamos la estructura completa del producto principal y la sección de recomendados
    ...
    // 2. Lógica para sumar/restar cantidad y actualizar precios en tiempo real
    ...
    // 4. Renderizar Productos Recomendados
